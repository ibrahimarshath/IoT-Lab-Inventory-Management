      ...
      <div className="max-w-2xl mx-auto">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            {!isEditing ? <Button size="sm" variant="outline" onClick={() => setIsEditing(true)} className="gap-2">
          ...
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                {isEditing ? <Input id="phone" type="tel" value={editData.phone} onChange={e => setEditData({
                ...editData,
              ...
              <div className="space-y-2">
                ...
                {isEditing ? <Input id="department" value={editData.department} onChange={e => setEditData({
                ...editData,
